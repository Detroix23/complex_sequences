//! # Complex sequences.
//! src/support/initialization.rs
//! 
//! Helper function with context and window initialization.
...
/// Font size from `support::initialization`, used in default startup procedures. 
...
pub fn with_startup<FInit, FUi, FUpdate>(
    title: &str, 
    window_size: [u32; 2],
    mut startup: FInit, 
    mut run_ui: FUi,
    ...
    FUpdate: FnMut(&mut Ui, &mut Renderer, &Display<WindowSurface>) + 'static,
{
    ...
    let title: &str = match Path::new(&title).file_name() {
